...
namespace MISA.AMIS.Core.Interfaces.Base
{
    ...
    public interface IBaseRepository<MISAEntity>
    {
        ...
        /// </summary>
        /// <param name="entityId">Id của nhân viên cần truy xuất</param>
        /// <returns>Thòn tin nhân viên</returns>
        /// Created By: LNTGiang(11/03/2022)
        ...
        /// <returns>Số lượng record thay đổi</returns>
        /// Created By: LNTGiang(11/03/2022)
